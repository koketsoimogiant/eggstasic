...
<body>
    ...
    <div class="container">
        <div class="row">
            <?php
                $sql = "SELECT * FROM orders INNER JOIN residence ON orders.residence = residence.id WHERE residence = ".$res;    // Refactor this database table to singular form.
                            ...
                            <div class="col-sm-4">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <span id="panel"><b>'.$row['res_name'].'</b>
                                        <span id="panel"><p>'.$row['num_trays'].' trays of eggs</p>
                                        <span id="panel"><p>to room: '.$row['roomnumber'].'</p>
                                        <span id="panel"><p>address specification: '.$row['address'].'</p>
                                        <span id="panel"><p>An Extra Note: '.$row['extranote'].'</p>';
                                        if ($row['res_orders'] > 0) {
